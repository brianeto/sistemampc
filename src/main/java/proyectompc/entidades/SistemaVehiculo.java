...
@NamedQueries({
    ...
    , @NamedQuery(name = "SistemaVehiculo.findById", query = "SELECT s FROM SistemaVehiculo s WHERE s.id = :id")
    , @NamedQuery(name = "SistemaVehiculo.findByNombre", query = "SELECT s FROM SistemaVehiculo s WHERE s.nombre = :nombre")})
public class SistemaVehiculo implements Serializable, Entidad {
    ...
    @ManyToMany(mappedBy = "sistemaVehiculoList")
    private List<Mantenimiento> mantenimientoList;
    @OneToMany(mappedBy = "sistemaVehiculoId")
    private List<Suministro> suministroList;

    public SistemaVehiculo() {
    }

    public SistemaVehiculo(Integer id) {
        this.id = id;
    }

    public SistemaVehiculo(Integer id, String nombre, String descripcion) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "proyectompc.entidades.SistemaVehiculo[ id=" + id + " ]";
    }
