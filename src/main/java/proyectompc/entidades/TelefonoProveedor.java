...
@NamedQueries({
    ...
    , @NamedQuery(name = "TelefonoProveedor.findById", query = "SELECT t FROM TelefonoProveedor t WHERE t.id = :id")
    , @NamedQuery(name = "TelefonoProveedor.findByNumero", query = "SELECT t FROM TelefonoProveedor t WHERE t.numero = :numero")})
public class TelefonoProveedor implements Serializable, Entidad {
    ...
    public TelefonoProveedor(Integer id) {
        this.id = id;
    }

    public TelefonoProveedor(Integer id, String numero) {
        this.id = id;
        this.numero = numero;
    }
    ...
    public String toString() {
        return "proyectompc.entidades.TelefonoProveedor[ id=" + id + " ]";
    }
